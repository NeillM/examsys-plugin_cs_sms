...
It allows Rogō to integration with the CAMPUS SOLUTIONS student management system calling a web services
hosted by a CAMPUS SOLUTIONS server to sync modules, enrolments, users etc.

Installation:

1. Extract plugin_cs_sms archive into the plugins/SMS directory inside Rogō.
